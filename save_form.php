...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO letters (date, letter_no, letter_by, receipet_no, dealt_by, midway_activity, status) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssss", $date, $letter_no, $letter_by, $receipet_no, $dealt_by, $midway_activity, $status);
